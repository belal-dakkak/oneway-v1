...
return [
    ...
    'a4_countries' => [
        2 => [
            ...
            'thanks' => 'Thank you for choosing One Way.',
            'branches' => [
                ['country' => 'Branch 1 : UAE – Ajman', 'phones' => ['+971 545 516 995', '+971 564 533 655']],
                ['country' => 'Branch 2 : Syria – Aleppo', 'phones' => ['+963 958 900 555', '+963 947 900 555']],
                ['country' => 'Branch 3 : Lebanon – Beirut', 'phones' => ['+961 81 730 725']],
                ['country' => 'Branch 4 : Turkey – Istanbul – Merter', 'phones' => ['+905 004 001 621']],
            ],
        ],
        4 => [
            ...
            'thanks' => 'شكرًا لتعاملكم مع One Way',
            'branches' => [
                ['country' => 'الفرع الأول: الإمارات – عجمان', 'phones' => ['+971 545 516 995', '+971 564 533 655']],
                ...
                ['country' => 'الفرع الرابع: تركيا – إسطنبول – مارتر', 'phones' => ['+905 004 001 621']],
            ],
        ],
    ],
    'a4_policy_headings' => ['ar' => 'سياسة الاستبدال', 'en' => 'Exchange Policy'],
    'a4_policy' => [
        'ar' => [
            ...
            'يجب استلام الطلبية خلال مدة أقصاها :days أيام من تاريخ الطلب، وفي حال عدم استلامها خلال المدة المحددة تُلغى الطلبية دون استرجاع العربون.',
        ],
        'en' => [
            ...
            'Orders must be collected within a maximum of :days days from the order date. If the order is not collected within the specified period, it will be cancelled without a refund of the deposit.',
        ],
    ],
    'one_way' => [
        'branches' => [
