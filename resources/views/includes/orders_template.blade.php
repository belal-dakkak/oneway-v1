...
@php
    $is_website_order = $is_website_order ?? false;
@endphp
<body>
    <?php
        ...
        <div class="row" style="margin-bottom: 50px">
            <table height="82" class=" " style=" width:100%;">
                <tr class="bg_color1">
                    ...
                    @if($is_website_order)
                    <td class="td-med"> Country <br> البلد </td>
                    @else
                ...
                @if($all_orders != null && is_array($all_orders) && array_key_exists('orders',$all_orders))
                    ...
                    @foreach($all_orders['orders'] as $key => $item)
                        ...
                        <tr class=" ">
                            ...
                            @endphp
                            <td class="td-med"> {{ $country_name }} </td>
                            @else
        ...
        <div class="row">
            <table height="82" class=" " style=" width:100%;">
                ...
                <tr class="">
                    ...
                    @if($seller != null && $seller->enable_tax == 'yes')
                        <td class="td-med"> {{ $all_orders['total_price_without_tax'] }} </td>
                        <td class="td-med"> {{ $all_orders['total_tax_value'] }} </td>
                        <td class="td-med"> {{ $all_orders['total_price_without_tax'] + $all_orders['total_tax_value'] }} </td>
                    @else
                        <td class="td-med"> {{ $all_orders['total'] }} </td>
                    @endif
