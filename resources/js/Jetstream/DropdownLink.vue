...
<template>
    <div dir="rtl">
        <button v-if="as == 'button'" type="submit" class="block w-full px-4 py-2 text-sm leading-5 text-gray-700 text-right hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition">
            <slot />
        </button>
