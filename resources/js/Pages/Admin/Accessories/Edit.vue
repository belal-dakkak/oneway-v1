        ...
        <div>
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                <form class="w-full" @submit.prevent v-on:submit.prevent>
                    ...
                    <jet-button :type="'button'" @click="updateAccessory">
                        حفظ
                    </jet-button>
                </form>
            </div>
...
export default defineComponent({
    ...
    methods: {
        updateAccessory() {
            ...
            this.form.post(route('accessories.update', this.accessory.id), {
                errorBag: 'updateAccessory',
                preserveScroll: true
            });
        }
    },
