        ...
        <div>
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                <form class="w-full" @submit.prevent v-on:submit.prevent>
                    ...
                    <jet-button :type="'button'" @click="updateFabric">
                        حفظ
                    </jet-button>
                </form>
            </div>
...
export default defineComponent({
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                color: this.fabric.color,
                yards: this.fabric.yards,
                user: this.warehouse,
                image: null,
            }),
    ...
    methods: {
        updateFabric() {
            ...
            this.form.post(route('fabrics.update', this.fabric.id), {
                errorBag: 'updateFabric',
                preserveScroll: true
            });
        }
    },
