...
export default defineComponent({
    ...
    props: {
        ...
        total_qty: Number,
        order_buyer: Object,
        order_shipper: Object,
        tax_ratio: Number,
        enable_tax: String,
    },
    mounted() {
        this.$refs.product[this.products.length-1].$el.focus()
    },
    data() {
        return {
            form: this.$inertia.form({
                ...
                user: this.order_buyer,
                shipper: this.order_shipper,
    ...
    watch: {
        ...
        'form.discount':{
            handler: throttle(function () {
                ...
                let priceAfterDiscount = Number(this.form.total_price_before_discount) - Number(this.form.discount)
                this.form.total_price = priceAfterDiscount;
                if(this.form.paid_price > priceAfterDiscount)
                this.form.paid_price = priceAfterDiscount;
            })
        }
    },
    setup() {
