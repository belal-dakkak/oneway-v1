              ...
              <tr v-for="item in userProducts.data"  class="font-sans-latin text-sm font-medium">
                  ...
                  <td class="mx-auto max-w-sm p-6 text-sm leading-6 sm:text-base sm:leading-7">
                      <div class="ml-4">
                          ...
                          <div class="text-sm text-center font-medium bg-rose-200 p-1 rounded-lg">Color: {{ item.product.color_name }} {{ item.product.color_code }}</div>
                      </div>
                  </td>
                  ...
                  <td class="mx-auto max-w-sm p-6 text-sm leading-6 sm:text-base sm:leading-7" v-if="admin.role != 3">
                      <div class="ml-4">
                          <div class="text-sm font-medium">{{ item.product && item.product.product && item.product.product.sale_price != null ? item.product.product.sale_price : 0 }}</div>
                      </div>
                  </td>
                  <td class="mx-auto max-w-sm p-6 text-sm leading-6 sm:text-base sm:leading-7">
                      <div class="ml-4">
      ...
      watch: {
          params: {
              handler: throttle(function () {
                  ...
                  axios.get(this.route('userProducts.all', this.params)).then(response => {
                      this.userProducts = {
                          ...response.data,
