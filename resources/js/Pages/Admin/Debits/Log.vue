...
export default defineComponent({
    ...
    methods: {
        // encodeUrlWhatsapp(){
        //     let number = this.creditor.phone;

        //     let url = encodeURIComponent(route('merchant.account.log', this.params));
        ...
        handleFilter(params){
            ...
            this.$inertia.get(this.route('debits.log', params), this.params, { replace: true, preserveState: true});
        },
        resetStartDate(){
