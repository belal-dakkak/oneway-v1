      ...
      <div class="container mx-auto px-4 max-w-4xl">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
          <h1 class="text-3xl md:text-4xl font-extrabold mb-8 text-black uppercase tracking-tight">
            {{ store.t('privacyPolicyTitle') }}
          </h1>
          <div class="prose prose-sm md:prose-base max-w-none text-gray-700 leading-relaxed policy-content" v-html="store.t('privacyPolicyContent')">
          </div>
        </div>
      </div>
    </main>
